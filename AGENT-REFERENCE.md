...
Read only the section relevant to the task. This is a navigation reference; confirm current files and scripts before use. Reset, publish, deploy and submission commands are not routine validation and require matching task authorization. Use Bun throughout.
