...
- A interface deve ocupar a maior parte da área útil do telefone.
- A gravação usa viewport móvel real, com largura CSS próxima de 360–390 pixels e densidade suficiente para produzir a entrega em 1080p.
...
- Nenhuma interface importante aparece pequena como no vídeo anterior.
